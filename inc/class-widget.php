...
class Listify_Widget extends WP_Widget {
	...
	public function admin_scripts() {
		...
		wp_register_script( 'chosen', get_template_directory_uri() . '/js/admin/vendor/jquery-chosen/chosen.jquery.min.js', array( 'jquery' ), '1.2.0' );
		...
		// Multiselect chosen.
		wp_register_script( 'listify-admin-multiselect-chosen', get_template_directory_uri() . '/js/admin/widget-multiselect.js', array( 'jquery', 'chosen' ) );
	}
